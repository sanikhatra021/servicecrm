            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li class="active"> Password Verify</li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <div id="lg1" class="tab-pane active">
                                    <div class="login-form-container">
                                        <div class="login-register-form">
                                            <form action="verifypassword2.php" method="post">
                                                <input type="hidden" name="samid" value="<?php echo $samid; ?>">
												<div>Your Mobile Number..</div>
												<input type="text" name="cmobile" value="<?php echo $cmobile; ?>" placeholder="OTP Code" required readonly>
												<div>Password</div>
