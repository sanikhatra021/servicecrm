            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
					...
					<div class="portlet-title green">
						<div class="caption">
							<i class="fa fa-gift"></i><small>Edit AMC</small>  </div>
						<div class="actions">
					...
					<?php
						...
						$eve = "select * from res_service_master  where amcid=$amcid and samid=$samid";
				...
				<!-- BEGIN FORM-->
				<form action="amcedit2.php" method="POST" class="form-horizontal" enctype="multipart/form-data" id="myForm">
				<input type="hidden" name="amcid" value="<?php echo $amcid; ?>">
					<div class="form-body">
					...
					<div class="form-group">
							...
							<div class="form-group" id="startdate">
								...
								<div class="col-md-5">
									<input class="form-control form-control-inline  date-picker" data-date-format="yyyy-mm-dd" type="text" name="sdate" value="<?php echo $sstartdate;?>" required>
							...
							<div class="form-group" id="enddate">
								...
								<div class="col-md-5">
									<input class="form-control form-control-inline  date-picker" data-date-format="yyyy-mm-dd" type="text" name="edate" value="<?php echo $senddate;?>" data-date-start-date="+0d" required >
