...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Contract Type Edit | Admin Panel</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
					...
					<div class="portlet-title green">
						<div class="caption">
							<i class="fa fa-gear"></i><small>Edit Contract Type</small>  </div>
						<div class="actions">
					...
					<?php
						...
						$eve = "select * from res_servicetype_master  where stypemid=$ctmid and samid=$samid";
				...
				<!-- BEGIN FORM-->
				<form action="servicetypeedit2.php" method="POST" class="form-horizontal" enctype="multipart/form-data" id="myForm">
				<input type="hidden" name="stypemid" value="<?php echo $ctmid; ?>">
				
					<div class="form-body">
							<div class="form-group">
								<label class="col-md-3 control-label">Contract Type<span class="required">*</span></label>	
								<div class="col-md-5">
									<input type="text" name="stypename" value="<?php echo $ctmname; ?>" class="form-control" required>
								</div>
							</div>
