...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Status Master  Edit | Admin Panel</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
					...
					<div class="portlet-title green">
						<div class="caption">
							<i class="fa fa-gift"></i><small>Edit Status Master</small>  </div>
						<div class="actions">
				...
				<!-- BEGIN FORM-->
				<form action="statusedit2.php" method="POST" class="form-horizontal" enctype="multipart/form-data" id="myForm">
				<input type="hidden" name="smid" value="<?php echo $smid; ?>">
				
					<div class="form-body">
							<div class="form-group">
								<label class="col-md-3 control-label">Status Master Name</label>
								<div class="col-md-5">
									<input type="text" name="smname" value="<?php echo $smname; ?>" class="form-control">
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-md-3 control-label">Status Priority No</label>
								<div class="col-md-5">
