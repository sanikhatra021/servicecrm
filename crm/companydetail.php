...
session_start(); 
	...
	$eve = "select * from res_company_master where cpmid=$cpmid";
...
<head>
<meta charset="utf-8" />
<title>Company Detail | Admin Panel</title>
...
<div class="form-body">
	...
	<div class="portlet box blue-hoki">
		...
		<div class="portlet-title" style="background-color:black;">
			<div class="caption">
				<i class="fa fa-gift"></i>Company Details</div>
			<div class="actions">
				<a href="company.php" class="btn white btn-outline sbold" > Back </a>
			</div>
		</div>
		...
		<div class="table-scrollable">
			<table class="table table-bordered">
				...
				<tr>								
					...
					<th>Company Name</th>
					<td><?php echo $cpmname;?></td>
					<th>Contact No</th>
					<td><?php echo $cpmcontacto;?></td>
				</tr>
				<tr>								
				...
				<tr>								
					...
					<th>Address</th>
					<td><?php echo $cpmaddress;?></td>
					<th>Whatsapp No</th>
					<td><?php echo $cpmwhatsappno;?></td>
				</tr>
				<tr>								
				...
				<tr>								
					...
					<th>Email</th>
					<td><?php echo $cpmemail;?></td>
					<th>Contact Perosn Name</th>
					<td><?php echo $cpmcontactpname;?></td>
				</tr>
				
				<tr>								
				<th>Website Details</th>
					<td><?php echo $cpmwebsitedetails;?></td>
