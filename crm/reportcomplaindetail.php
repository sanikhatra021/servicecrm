...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>All Call Detail Report | Admin Panel</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box" style="background-color:#0078BF;">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="reportcomplaindetail.php" method="post" class="form-horizontal form-bordered">
                                      <div class="form-body">
						 ...
						 <div class="form-group">
								<label class="col-md-2 control-label">Service Engineer<span class="required"></span></label>
								<div class="col-md-4">
									<select class="form-control select2" name="serviceengineerid"   required>
										<option value="all">All</option>
										
										<?php
										$eve_main = "select * from res_user_master where samid=$samid and utype='serviceengineer'";
										$re_main = mysqli_query($conn, $eve_main);
										while($rt_main = mysqli_fetch_assoc($re_main))
										{
											
											$umid1=$rt_main['umid'];
											$uname1=$rt_main['uname'];
											if($_POST['serviceengineerid']==$umid1)
											{
								 ...
								 <label class="col-md-1 control-label">Status<span class="required">  </span></label>
								
								<div class="col-md-3">
									<select class="form-control select2" name="cstatus">
									<option value="all">All</option>
										<option  <?php if($_POST['cstatus']=="Pending"){echo "selected";}?>  value="Pending">Pending</option>
										<option  <?php if($_POST['cstatus']=="In Process"){echo "selected";}?> value="In Process">In Process</option>
										<option  <?php if($_POST['cstatus']=="Completed"){echo "selected";}?> value="Completed">Completed</option>
										
										<option  <?php if($_POST['cstatus']=="Cancel"){echo "selected";}?>value="Cancel">Cancel</option>
									</select>
								...
								<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
									...
									$i=1;
										...
										if(isset($_POST['umid']))
										{
											...
											{
												$tt=" and res_complain_master.customerid=$customerid";
											}
										}
										        
										if(isset($_POST['serviceengineerid']))
										{
											$serviceengineerid=$_POST['serviceengineerid'];
											if($serviceengineerid=='all')
											{
												$tt1="";
											}
											else
											{
												$tt1=" and res_complainallocation_detail.serviceengid=$serviceengineerid";
											}
										}
										 if(isset($_POST['cstatus']))
										{
											...
											{
												$tt2=" and res_complain_master.cstatus='$status'";
											}
										} 
										  ...
										  $eve22 = "SELECT * FROM res_complain_master,res_complainallocation_detail where res_complain_master.samid=$samid and res_complain_master.cmdate between '$lower' and '$upper' $tt  $tt1 $tt2 and res_complainallocation_detail.cmid=res_complain_master.cmid order by res_complain_master.cmid desc ";
									 ...
									 while($rt22 = mysqli_fetch_assoc($re22))
										{
											...
											$cmserviceengineerid = $rt22['serviceengid'];
											...
											while($rt128 = mysqli_fetch_assoc($re128))
											{
												 ...
												 $umobile=$rt128['umobile'];
												 $usite=$rt128['usite'];
												  $upriority=$rt128['upriority'];
											}
