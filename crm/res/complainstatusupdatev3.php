<?php
 ...
 include("../connect.php");
	...
	$par22 = $_GET['p22'];	//cdid
	$par23=$_GET['p23'];  //latitude
	$par24=$_GET['p24'];	//longitude
	$par25=$_GET['p25'];	//full address
	...
	if(mysqli_num_rows($re_category3) > 0)
    {
		while($rt_category3 = mysqli_fetch_assoc($re_category3))
		{
		    ...
		    $eve1 = "update res_complain_detail set custid ='$par4',cdphoto='$cdphoto1',cdstatus='$par7',cdendtime='$mdate',cdupdatedon='$mdate',cdservicecharge='$par8',cdmachinemodel='$par11',cdmachinesrno='$par12',cdmachinelocation='$par13',cdworkdone='$par14',cdpendingwok='$par15',cdsign='$cdsign1',cdcustremarks='$par17',cdremark ='$par10',cdendlatitude ='$par23',cdendlongitude ='$par24',cdendaddress ='$par25',cactive = 0  where cdid='$par22' and cactive=1"; 
