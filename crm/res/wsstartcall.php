		...
		//$serviceengineerid =0;
			while($rt2 = mysqli_fetch_assoc($re2))
			{
				...
				$last_id = "0";
				 ...
				 $eve113 = "INSERT INTO res_complain_detail (cmid,custid,samid, serviceengineerid,cdstatus,cdaddedon,cactive,cdstarttime,assigndate)
				 VALUES ($par3, '$customerid', '$samid', '$serviceengineerid', '$cstatus', '$mdate', 1, '$mdate','$cmdate')";
