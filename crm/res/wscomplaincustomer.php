...
error_reporting(E_ERROR | E_PARSE);
	...
	if(mysqli_num_rows($re1) > 0)
	{
		...
		{
			  $eve2 =  "SELECT * FROM  res_complain_master,res_complain_detail where res_complain_master.cmid=res_complain_detail.cmid and res_complain_detail.serviceengineerid=$serviceengineerid and samid=$samid";
			  $re2 = mysqli_query($conn,$eve2);
		}
		if(mysqli_num_rows($re2) > 0)
		{
			...
			while($rt2 = mysqli_fetch_assoc($re2))
			{
				...
				$msg = "Success";
				$posts[] = array('p1'=> $result,'p2'=> $cmdetail,'p3'=> $cmdate,'p4'=> $cmphoto,'p5'=> $cstatus,'p6'=> $ctmname,'p7'=> $pmname,'p8'=> $uname,'p9'=> $uaddress,'p10'=> $umid,'p11'=> $pmid,'p12'=> $ctmid,'p13'=> $cmid,'p14'=> $cdid,'seruname'=>$seruname);
			}
