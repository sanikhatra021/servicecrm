...
error_reporting(E_ERROR | E_PARSE);
	...
	if(mysqli_num_rows($re_category) > 0)
    {
		...
		$cmnowithprefix=$saprefix.$cmno1;
		   	  ...
		   	  $eve1 = "insert into res_complain_master (cmno,ctmid,pmid,customerid,cmdate,cmdetail,cstatus,samid,cmserviceengineerid,cmupdatedon,cmupdatedby,cmaddedby,cmaddedon,cmnowithprefix) values($cmno1,'$par3','$par4','$par5','$par6','$par7','Pending','$samid','$umid','$mdate1','$umid','$umid','$mdate1','$cmnowithprefix')";
