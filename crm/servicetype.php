...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Contract Type | Admin Panel</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                   <h3> <i class="fa fa-gear"></i>
                                    <span class="caption-subject bold uppercase">Contract Type </span> </h3>
                                </div>
                                <div class="actions">
							
									<div class="tools">
										<button id="sample_editable_1_new" class="btn sbold green" onClick="document.location.href='servicetypeadd.php?from=service'">
											Add New
							...
							<div class="alert alert-block alert-info fade in hidden">
									...
									<p>Here Create the type of Contract .</p>
							</div>
...
$(document).ready(function() {
    $('#sample_5').DataTable( {
        ...
        "columns": [
		   ...
		   { "data": "ctmname","title":"Contract Type" },
