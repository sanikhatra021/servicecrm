                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">Completed Service </span>
                                </div>
                                <div class="actions">
							...
							<div class="alert alert-block alert-info fade in">
									...
									<p>Here we can see completed & cancel service list.</p>
								</div>
							<!------------>
		 ...
		 <div class="modal-dialog">
			  <div class="modal-content">
				   ...
				   <div class="modal-header">
					 ...
					 <input type="hidden" name="from" value="scs">
...
$(document).ready(function() {
    $('#sample_5').DataTable( {
        "ajax": "./completedservicelistjson.php",
		"language": {
