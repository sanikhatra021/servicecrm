...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Completed Service Call Detail Report | Admin Panel</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box" style="background-color:#0078BF;">
                                <div class="portlet-title">
                                    <div class="caption">
                                        Completed Service Call Report</div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="reportcompletedcall.php" method="post" class="form-horizontal form-bordered">
                                      <div class="form-body">
								...
								<label class="col-md-1 control-label">Service Engineer<span class="required"></span></label>
								<div class="col-md-2">
									...
									/* 	 if(isset($_POST['cstatus']))
										{
										  ...
										  $eve22 = "SELECT * FROM res_complain_master,res_complainallocation_detail where res_complain_master.samid=$samid and res_complain_master.cmupdatedon between '$lower' and '$upper' $tt  $tt1  and res_complain_master.customerid in(select umid from res_user_master) and cstatus='Completed' and res_complain_master.cmid=res_complainallocation_detail.cmid order by res_complain_master.cmid desc ";
