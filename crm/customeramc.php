...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title> Customer AMC | Admin Panel</title>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                ...
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase"> Customer AMC</span>
                                </div>
                                <div class="actions">
								<!--<div class="btn-group">
								...
								<div class="btn-group">
									<button id="sample_editable_1_new" class="btn sbold green" onClick="document.location.href='amcadd.php'">
										Add New
