                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
									...
									<div class="btn-group">
										<button id="sample_editable_1_new" class="btn sbold green  hidden-print" onClick="document.location.href='complainadd.php'">
											Add New 
							...
							<div class="alert alert-block alert-info fade in  hidden-print">
									<button type="button" class="close" data-dismiss="alert"></button>
									<p>Here create Call by selecting different options as per availiblity.</p>
								</div>
							<!------------>
							
							<form method="post" class="form-horizontal form-bordered" action="revenewreport.php">
							<div class="form-body">
                                                ...
                                                <div class="col-md-3">
												 ...
												 <label class="col-md-1 control-label">Status </label>
													...
													<div class="col-md-2">
														...
														<?php
										echo $eve_category1 = "select * from res_complaintype_master where  samid='$samid'";
										...
										while($rt_category1 = mysqli_fetch_assoc($re_category1))
										{
											...
											if(isset($_SESSION['cmtype']) && $_SESSION['cmtype']==$uname1){
												echo "<option value='$uname1' selected>$uname1</option>";
											}
											else{
									...
									?>
                                               ...
                                               <div class="col-md">
                                                    <button type="submit" name="btnsubmit" class="btn red  hidden-print">
		 ...
		 <div class="modal-dialog">
			  <div class="modal-content">
				   ...
				   <div class="modal-header">
					 ...
					 <input type="hidden" name="from" value="cmp">
...
$(document).ready(function() {
    $('#sample_5').DataTable( {
        ...
        "columns": [
				...
				{ "data": "pmname","title":"Product" },
				{ "data": "cmcharge","title":"Complain Charge" },
				
				{ "data": "cmtype","title":"Call Type" },
				{ "data": "cmproblemtype","title":"S.Problem" },
				
				
				//{ "data": "cmdetail","title":"Call Detail" },
				{ "data": "staff","title":"Staff" },
				
			//	{ "data": "serviceno","title":"Service No" },
			  // { "data": "servicestatus","title":"Status"},
			//   { "data": "pmname","title":"Product Name" },
			 //  { "data": "uname","title":"Customer Name" },
			 //  { "data": "sstartdate","title":"Service Start Date" },
			  // { "data": "senddate","title":" Service End Date" },
			   { "data": "sservicecharge","title":" Service Charge" },
			//   { "data": "sremarks","title":"Remark" },
			//   { "data": "sserialno","title":"Serial No" },
			   { "data": "servicetype","title":"Service Type" },
			 //  { "data": "snoofseat","title":" No Of Service  " },
		 ...
		 <script>
          ...
          function ExportToExcel(type, fn, dl) {
              ...
              return dl ?
                  ...
                  XLSX.writeFile(wb, fn || ('Complain.' + (type || 'xlsx')));
          }
