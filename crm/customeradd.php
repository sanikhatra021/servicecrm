...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Customer Add | Admin Panel</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
					...
					<div class="portlet-title green">
						<div class="caption">
							<i class="fa fa-user"></i><small>Add Customer</small> </div>
						<div class="actions">
					...
					if(isset($_GET['id']))
					{
						...
						while($rt = mysqli_fetch_assoc($re))
						{
							...
							$uloc2=$rt['uloc2'];
							$usite=$rt['usite'];
							$uprojectengname=$rt['uprojectmanagername'];
							$uprojectmanagermobile=$rt['uprojectmanagermobile'];
							$uprojectinchargename=$rt['uprojectinchargename'];
							$uprojectinchargemobile=$rt['uprojectinchargemobile'];
						}
					}	
					?>
					<!-- BEGIN FORM-->
					<form action="customeradd2.php" method="POST" class="form-horizontal" enctype="multipart/form-data" id="myForm">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="password" name="upassword" value="<?php echo $upassword; ?>" class="form-control" >
							 </div>
						</div>
						</div>
						<div class="col-md-6">
						...
						<!--<div class="form-group">
							...
							<div class="col-md-5">
									<select class="form-control select2" name="utype" id="utype">
						...
						<div class="form-group">
									...
									<div class="col-md-8">
										<textarea type="text"  rows="1" class="form-control" name="uaddress" ><?php echo $uaddress; ?></textarea>
									</div>
								</div>
								</div>
								</div>
				...
				<div class="row">						
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" name="uprojectmanagername" value="<?php echo $uprojectmanagername; ?>" class="form-control" >
							 </div>
						</div>
						</div>				
							<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" name="uprojectmanagermobile" value="<?php echo $uprojectmanagermobile; ?>" class="form-control" >
							 </div>
						</div>
						</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" name="uprojectinchargename" value="<?php echo $uprojectinchargename; ?>" class="form-control" >
							 </div>
						</div>
						</div>				
							<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" name="uprojectinchargemobile" value="<?php echo $uprojectinchargemobile; ?>" class="form-control" >
							 </div>
						</div>
						</div>
						</div>
