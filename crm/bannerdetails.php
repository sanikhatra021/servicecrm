...
session_start(); 
	...
	if(mysqli_num_rows($re) > 0)
	{
		while($rt = mysqli_fetch_assoc($re))
		{
				...
				{
					$bannerimg1="<img src='images/$bannerimg' width='200px' height='200px'>";
				}
				else
				{
					$bannerimg1="<img src='images/noimage.jpg' width='200px' height='200px'>";
				}
...
<div class="form-body">
	...
	<div class="portlet box blue">
		...
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-eye fa-lg"></i>Banner Details</div>
			<div class="actions">
				<a href="banner.php" class="btn white btn-outline sbold" ><i class="fa fa-arrow-left"></i> Back </a>
			</div>
		</div>
		...
		<div class="table-scrollable">
			<table class="table table-bordered">
				<tr>
					<th>Banner</th>
					<td><?php echo $bannerimg1;?></td>
				</tr>
				<tr>
					<th>Banner Name</th>
					<td><?php echo $bmname;?></td>
				</tr>
				<tr>
					<th>Sort Order</th>
					<td><?php echo $bannerimgsortorder;?></td>
				</tr>
