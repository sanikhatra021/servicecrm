            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
					...
					<div class="portlet-title green">
						<div class="caption">
							<i class="fa fa-cogs"></i><small>Edit Setting</small>  </div>
						<div class="actions">
					...
					<?php
						$semid=1;
						$eve = "select * from res_settings_master  where semid=$semid";
						$re = mysqli_query($conn, $eve);
						while($rt = mysqli_fetch_assoc($re))
						{
							
							$sappversion=$rt['sappversion'];
							$sapplink=$rt['sapplink'];
				...
				<!-- BEGIN FORM-->
				<form action="settingedit2.php" method="POST" class="form-horizontal" enctype="multipart/form-data" id="myForm">
				<input type="hidden" name="semid" value="<?php echo $semid; ?>">
					<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<input type="text" name="sappversion" value="<?php echo $sappversion; ?>" class="form-control" aria-required="true" aria-invalid="false" aria-describedby="name-error" >
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">App Link</label>
								<div class="col-md-5">
									<input type="text" name="sapplink" value="<?php echo $sapplink; ?>" class="form-control" aria-required="true" aria-invalid="false" aria-describedby="name-error" >
								</div>
							</div>
							<!-- /input-group -->
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<button type="button" class="btn grey-salsa btn-outline" onclick="document.location.href='settingedit.php'"><i class="fa fa-arrow-left"></i> Cancel</button>
							</div>
						</div>
					</div>
				</form>
