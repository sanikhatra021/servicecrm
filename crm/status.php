...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Status Master | Admin Panel</title>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">Status Master </span>
                                </div>
                                <div class="actions">
							
									<div class="btn-group">
										<button id="sample_editable_1_new" class="btn sbold green" onClick="document.location.href='statusadd.php'">
											Add New
...
$(document).ready(function() {
    $('#sample_5').DataTable( {
        ...
        "columns": [
		   ...
		   { "data": "smid","title":"Sr No" },
		   { "data": "smname","title":"Status Master Name" },
		   { "data": "smpriorityno","title":"Status Priority No"},
