                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                ...
                                <div class="actions">
									...
									<div class="btn-group">
										<button id="sample_editable_1_new" class="btn sbold green" onClick="document.location.href='companyadd.php'">
											Add New
								...
								<div class="alert alert-block alert-info fade in">
									...
									<p>Here Create Company for Customer .</p>
								</div>
...
$(document).ready(function() {
    $('#sample_5').DataTable( {
        "ajax": "./companyjson.php",
		"language": {
			 "loadingRecords": "No Data found..."
		  }, 
        "columns": [
           
		   { "data": "cpmid","title":"Sr No" },
		   { "data": "cpmname","title":"Company Name" },
		   { "data": "cpmcontacto","title":"Contact No" },
		   { "data": "cpmwhatsappno","title":"Whatsapp No" },
		   { "data": "cpmemail","title":"Email" },
		   { "data": "cpmaddress","title":"Address" },
		   { "data": "cpmcontactpname","title":"Contact Person Name" },
		   { "data": "cpmwebsitedetails","title":"Website Details" },
