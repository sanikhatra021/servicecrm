...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Call Type | Admin Panel</title>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">Call Type </span></h3>
                                </div>
                                <div class="actions">
							
									<div class="tools">
										<button id="sample_editable_1_new" class="btn sbold green" onClick="document.location.href='complaintypeadd.php?from=complaintype'">
											Add New
							...
							<div class="alert alert-block alert-info fade in hidden">
									...
									<p>Here Create the type of Call for which Call will be registered.</p>
							</div>
...
$(document).ready(function() {
    $('#sample_5').DataTable( {
        "ajax": "./complaintypejson.php",
		"language": {
			 "loadingRecords": "No Data found..."
		  }, 
        "columns": [
           
		   { "data": "ctmid","title":"Sr No" },
		   
		   { "data": "ctmname","title":"Call Type Name" },
