                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                   <h3> <i class="fa fa-gear"></i>
                                    <span class="caption-subject bold uppercase">Add Service Contract</span></h3>
                                </div>
                                <div class="actions">
							
									<div class="btn-tools">
										</br>
										<button id="sample_editable_1_new" class="btn btn-md sbold green" onClick="document.location.href='serviceadd.php'">
											Add New
								...
								<div class="alert alert-block alert-info fade in hidden">
									...
									<p>Here create on AMC of Customer based on the product selection for the given time.</p>
								</div>
...
$(document).ready(function() {
    $('#sample_5').DataTable( {
        "ajax": "./servicejson.php",
		"language": {
			 "loadingRecords": "No Data found..."
		  }, 
        "columns": [
           
		   { "data": "amcid","title":"Sr No" },
		   { "data": "serviceno","title":"Contract No"},
		   { "data": "uname","title":"Customer Name" },
		   { "data": "servicestatus","title":"Status"},
		   { "data": "pmname","title":"Product Name" },
		   { "data": "sstartdate","title":"Contract Start Date" },
		   { "data": "senddate","title":" Contract End Date" },
		   { "data": "sservicecharge","title":" Contract Charge" },
		   { "data": "sremarks","title":"Remark" },
		   { "data": "sserialno","title":"Serial No" },
		   { "data": "servicetype","title":"Contract Type" },
