...
session_start(); 
	...
	else if(isset($_GET['cstatus']))
	{
		...
		$upper =  date('Y-m-d',strtotime('+1 months'));
...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Upcomming Service | Admin Panel </title>
                            ...
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                   <h3>  <i class="fa fa-user-plus"></i>
                                    <span class="caption-subject bold uppercase">Upcomming Service </span></h3>
                                </div>
                                <div class="actions">
										   ...
										   <div class="caption font-dark">
												...
												<div class="actions">
													...
													<div class="col-md-2">Status
													  ...
													  <div class="col-md-2">Date Ranges
