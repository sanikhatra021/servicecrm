                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                               ...
                               <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">Pending Payement  Report </span>
								</div>
                                <div class="actions">
                            ...
                            <div class="portlet box" style="background-color:#0078BF;">
								...
								<div class="col-md-2">
									...
									<option value="all">All</option>
										<option  <?php if($_POST['ptype']=="Unpaid"){echo "selected";}?>  value="Unpaid">Unpaid</option>
										<option  <?php if($_POST['ptype']=="Partial Paid"){echo "selected";}?> value="Partial Paid">Partial Paid</option>
								...
								<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_2">
									...
									$i=1;
										...
										if(isset($_POST['ptype']))
										{
										  ...
										  if($ptype == 'Unpaid'){
										  $eve22 = "SELECT * FROM res_complain_master where samid=$samid and cmdate between '$lower' and '$upper' $tt and (cmpaystatus='Unpaid' or cmpaystatus='') and cmtotalamount != 0  and customerid in(select umid from res_user_master) order by cmid desc ";
										  }else{
											  $eve22 = "SELECT * FROM res_complain_master where samid=$samid and cmdate between '$lower' and '$upper' $tt and cmpaystatus='Paid' and cmpayamount < cmnetamount  and customerid in(select umid from res_user_master) order by cmid desc ";
										  }
								...
								while($rt21 = mysqli_fetch_assoc($re21))
								{
									...
									$paymentremark=$rt21['paymentremark'];
										...
										<tr class="odd gradeX">
											...
											<td> <?php echo $cmpayamount; ?> </td>
											<td> <?php echo $cmpaymentmode; ?> </td>
