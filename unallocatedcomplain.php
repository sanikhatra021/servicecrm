...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Unallocation Complain | Admin Panel </title>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase">Unallocation Complain </span>
                                </div>
                                <div class="actions">
							
									<!--<div class="btn-group">
										<button id="sample_editable_1_new" class="btn sbold green" onClick="document.location.href='complainadd.php'">
											Add New 
							...
							<!--<div class="alert alert-block alert-info fade in">
									...
									<p>Here create Complain by selecting different options as per availiblity.</p>
								</div>-->
							<!------------>
...
$(document).ready(function() {
    $('#sample_5').DataTable( {
        "ajax": "./unallocatedcomplainjson.php",
		"language": {
        ...
        "columns": [
				...
				{ "data": "cname","title":"Customer Name" },
				
				{ "data": "ctype","title":"Complain Type"},
				{ "data": "pmname","title":"Product Name" },
				
				{ "data": "cstatus","title":"Status" },
				{ "data": "cmdate","title":"Date" },
				{ "data": "staff","title":"Service Engineer" },
