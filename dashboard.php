...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
			...
			<?php
					$eve1="select count(*) as v1 from res_complain_master where samid=$samid and cmserviceengineerid='0' and cstatus!='Completed' and customerid in(select umid from res_user_master)";
				  ...
				  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="dashboard-stat blue">
							...
							<div class="details">
								...
								<div class="desc">Unallocated</div>
							</div>
							<a class="more" href="unallocatedcomplain.php"> Total <?php echo $vtotal;?>
				...
				?>
				  ...
				  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="dashboard-stat green" >
							...
							<a class="more" href="pendingcomplain.php"> Total <?php echo $ptotal;?>
								<i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
				</div>
				...
				?>
				  ...
				  <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="dashboard-stat blue">
							...
							<a class="more" href="#.php"> Total <?php echo $ptotal;?>
								<i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
				</div>
			...
			<?php
					$eve1="select count(*) as v1 from res_service_master where samid=$samid";
					$re1= mysqli_query($conn, $eve1) or die("failed re1");
					$atotal=0;
					while($rt1 = mysqli_fetch_assoc($re1))
					{
						$atotal=$rt1['v1'];
				    ...
				    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						<div class="dashboard-stat green">
							...
							<div class="details">
								...
								<div class="desc">Service List</div>
							</div>
							<a class="more" href="service.php"> Total <?php echo $atotal;?>
								<i class="m-icon-swapright m-icon-white"></i>
							</a>
						</div>
				</div>
				...
				<div class="col-md-12">
						 ...
						 <div class="portlet box green">
                                <div class="portlet-title">
									...
									<div class="tools">
										 <button id="sample_editable_1_new" class="btn white btn-outline sbold" onClick="document.location.href='unallocatedcomplain.php'">
				...
				<!--- portlet 2 --->
				  <div class="col-md-12">
						 ...
						 <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-user"></i>Pending Complain</div>
									<div class="tools">
											...
											<div class="table-scrollable">
												<table class="table table-striped table-hover">
													...
													{ */
														...
														/* $eve1 = "select * from res_complain_master where cstatus!='Completed' and cstatus!='Scheduled'  and samid=$samid  and customerid in(select umid from res_user_master) order by cmid desc limit 0,5"; */
														$eve1 = "select * from res_complain_master where cstatus='pending' and cmserviceengineerid!=0 and samid=$samid  and customerid in(select umid from res_user_master) order by cmid desc limit 0,5";
														$re1 = mysqli_query($conn, $eve1);
													/* }
													else if($_SESSION['utype']=='customer')
													{
														$eve1 = "select * from res_complain_master where samid =$samid and cstatus!='Completed' and cstatus!='Scheduled' and customerid='".$_SESSION['umid']."' order by cmid desc limit 0,5";
														$re1 = mysqli_query($conn, $eve1);
													} */
				...
				<!--- portlet 3 ---->
				 <div class="col-md-12">
						 ...
						 <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-user"></i>Upcoming Service Renewal</div>
									<div class="tools">
										 <button id="sample_editable_1_new" class="btn white btn-outline sbold" onClick="document.location.href='service.php'">
											 View All <i class='fa fa-tv'></i>
											...
											<div class="table-scrollable">
												<table class="table table-striped table-hover">
													...
													$i=1;
													    ...
													    $eve1 = "select * from res_service_master where sstartdate>='$cdate' and sstartdate<='$nextday' ";
														$re1 = mysqli_query($conn, $eve1);
													    while($rt1 = mysqli_fetch_assoc($re1))
													    {
														...
														$pmid=$rt1['pmid'];
														$custid=$rt1['custid'];
														$sstartdate=date("Y-m-d",strtotime($rt1['sstartdate']));
														$senddate=date("Y-m-d",strtotime($rt1['senddate']));
														$spurchasedate=date("Y-m-d",strtotime($rt1['spurchasedate']));
														$sremarks=$rt1['sremarks'];
														$sserialno=$rt1['sserialno'];
														$snoofseat=$rt1['snoofseat'];
														$servicetype=$rt1['servicetype'];
														
														
														$eve12 = "select * from res_product_master where pmid=$pmid";
														...
														$eve122 = "select * from res_user_master where umid=$custid";
														$re122 = mysqli_query($conn, $eve122);
														while($rt122= mysqli_fetch_assoc($re122))
														{
															$uname=$rt122['uname'];
